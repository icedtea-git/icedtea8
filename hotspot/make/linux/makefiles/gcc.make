...
# There are currently null pointer issues flagged with GCC 11 on
# PPC64 in assembler_ppc.inline.hpp and macroAssembler_ppc_sha.cpp
# Make these non-fatal for now. See PR
ifeq ($(BUILDARCH), ppc64)
  WARNING_FLAGS += -Wno-error=nonnull
endif

CFLAGS_WARN/DEFAULT = $(WARNINGS_ARE_ERRORS) $(WARNING_FLAGS)
# Special cases
CFLAGS_WARN/BYFILE = $(CFLAGS_WARN/$@)$(CFLAGS_WARN/DEFAULT$(CFLAGS_WARN/$@)) 
# The Zero assembler port is expected to return NULL from some
# functions which will never actually be called in use (and also
# contain ShouldNotCallThis to crash the VM; see PR3838)
ifeq ($(JVM_VARIANT_ZERO), true)
  CFLAGS_WARN/compiledIC.o = $(CFLAGS_WARN/DEFAULT) -Wno-nonnull
  CFLAGS_WARN/sharedRuntime.o = $(CFLAGS_WARN/DEFAULT) -Wno-nonnull
endif
